...
//             className="px-4 py-2 bg-gray-50  hover:bg-gray-200 rounded-xl text-sm font-medium text-gray-700 transition"
//           >
//             Back Home
//           </button>
//         </div>
...
//         <div className="bg-white border border-gray-200 rounded-3xl shadow-sm min-h-full px-5 py-4">

//           {messages.length === 0 && (
//             <div className="h-full flex flex-col items-center justify-center text-center pt-16">
//               <div className="bg-white border border-gray-200 shadow-sm rounded-3xl px-10 py-8 max-w-md">
...
//                   msg.role === 'user'
//                     ? 'bg-gray-900 text-white shadow-md rounded-3xl rounded-br-lg'
//                     : 'bg-white border border-gray-200 text-gray-800 shadow-sm rounded-3xl rounded-bl-lg'
//                 }`}>
//                   {msg.role === 'user' ? (
//                     msg.text
//                   ) : (
...
//                           speaking === i ? 'text-red-500' : 'text-gray-400 hover:text-gray-700'
//                         }`}
//                       >
//                         {speaking === i ? '⏹️ Stop' : '🔊'}
//                       </button>
...
//                 <div className="bg-white border border-gray-200 shadow-sm px-4 py-3 rounded-3xl flex gap-1">
...
//         <div className="bg-white border border-gray-300 rounded-3xl shadow-md px-3 py-3 flex items-center gap-3">
...
//             onClick={sendMessage}
//             disabled={loading}
//             className="shrink-0 bg-black hover:bg-gray-800 active:scale-95 disabled:opacity-50 transition-all text-white px-5 py-2 rounded-xl font-medium text-sm"
//           >
//             Send
//           </button>
//         </div>
